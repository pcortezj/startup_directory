    ...
    const handleFormSubmit = async (prevState: any, formData: FormData) => {
        try {
            ...
            if (error instanceof z.ZodError) {
                ...
                toast("Error", { description: "Please check your inputs and try again", className: "bg-red-600 text-white" });

                return {...prevState, error: 'Validation failed', status: "ERROR"}
            }
            toast("Error", { description: "An unexpected error has occurred", className: "bg-red-600 text-white" });
    ...
    return (
        <form action={formAction} className='startup-form'>
            ...
            <div>
                ...
                <Input id="category" name="category" className="startup-form_input" required placeholder="Startup Category (Tech, Health, Web3...)" />
            ...
            <div data-color-mode="light">
                ...
                <MDEditor
                    ...
                    textareaProps={{ placeholder: "Amuse us with you startup idea" }}
